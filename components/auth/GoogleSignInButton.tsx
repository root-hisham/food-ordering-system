...
export function GoogleSignInButton({ redirectTo }: { redirectTo?: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex w-full items-center justify-center gap-2 rounded-xl border border-neutral-200 bg-white py-3 font-medium text-neutral-700 shadow-sm transition hover:bg-neutral-50"
    >
